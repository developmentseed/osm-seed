console.log(`import _chunk from 'lodash-es/chunk';
...
var urlroot = '${process.env.ID_APPLICATION_URL}';
var oauth = osmAuth({
    url: urlroot,
    oauth_consumer_key: '${process.env.ID_APPLICATION_OAUTH_CONSUMER_KEY}',
    oauth_secret: '${process.env.ID_APPLICATION_OAUTH_SECRET}',
    loading: authLoading,
    done: authDone
});
